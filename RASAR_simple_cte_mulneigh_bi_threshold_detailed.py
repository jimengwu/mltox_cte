...
for repeat in range(args.repeat):
        ...
        for ah in sequence_ah:
            for ap in sequence_ap:
                for thres in threshold_ls:
                    ...
                    X_labled = conc_to_label(X, thres)
    ...
    print("best alphas and threshold found.", best_ah, best_ap, best_thres)
    X_traintest = conc_to_label(X_traintest, best_thres)
    X_valid = conc_to_label(X_valid, best_thres)
    X_labled = conc_to_label(X, best_thres)
