...
def getArguments():
    parser = argparse.ArgumentParser(
        description="Running datafusion RASAR model for stratified splitting datasets, \
    ...
    parser.add_argument("-ap", "--alpha_p", dest="pubchem2d_alpha", nargs="?")
    parser.add_argument(
        "-dbi",
        "--db_invitro",
        dest="db_invitro",
...
if best_param != "default":
    ...
    df_test_score.loc[0, "params"] = "default"
